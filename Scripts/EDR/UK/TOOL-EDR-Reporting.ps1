# Цей скрипт отримує статус EDR в аркуші Excel електронною поштою.
# Потрібні модулі: Active Directory та ImportExcel
# WinRM увімкнено на кожному сервері/комп’ютері та потрібні права адміністратора для запуску Powershell ISE
