# This script assigns 3 different license types by Active Directory group.
# Place this script in a scheduled task and run it every hour, 24/7
# This script uses the MSOnline and Active Directory modules
...
# 3 license setup. Enter your own AD group and 365 license name.
...
# Send email when license volume is under 3
