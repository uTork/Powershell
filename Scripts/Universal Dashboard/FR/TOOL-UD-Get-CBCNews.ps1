...
<#
.SYNOPSIS
Afficher les nouvelles CBC
.DESCRIPTION
Transformer le fil RSS de CBC en objet ou en HTML
.PARAMETER GENERAL_NEWS
Afficher les nouvelles générales
.PARAMETER SPORTS_NEWS
Afficher les nouvelles sportives
.PARAMETER REGIONAL_NEWS
Afficher les nouvelles régionales
.PARAMETER HTML
Affiche les nouvelles sur un résumé en HTML qui s'ouvre dans le navigateur.
.LINK
Sebastien Maltais
...
# Adresse RSS des nouvelles sportives
$SPORTSNEWS = @{
...
# Adresse RSS des nouvelles régionales
$REGIONALNEWS = @{
...
# Adresse RSS de The National
$THENATIONAL = @{
                    In_Depth_Reports = "https://rss.cbc.ca/lineup/thenational.xml"
                 }

# Sélectionner le fil RSS des nouvelles générales
if($GENERAL_NEWS -NE ""){
                         $RSS = $GENERALNEWS."$GENERAL_NEWS"                          
                        }

# Sélectionner le fil RSS des nouvelles régionales
if($REGIONAL_NEWS -ne ""){                       
                         $RSS = $REGIONALNEWS."$REGIONAL_NEWS"
                         }

# Sélectionner le fil RSS The National
if($THE_NATIONAL -ne ""){
