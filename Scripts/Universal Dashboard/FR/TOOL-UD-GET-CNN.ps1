...
<#
.SYNOPSIS
Obtenir les nouvelles CNN via RSS
.DESCRIPTION
Convertir les nouvelles CNN en objet PowerShell pour Universal Dashboard ou en HTML pour la lecture
.PARAMETER Category
Catégorie de nouvelles
.PARAMETER HTML
Afficher les nouvelles en HTML
.LINK
Sebastien Maltais
