...
<#
.SYNOPSIS
NASA Picture of the Day / Needs internet to work
.DESCRIPTION
...
# Get your personal free API key on the NASA website https://api.nasa.gov/index.html#apply-for-an-api-key
...
# Output the picture of the day object
if($savepath -eq "" -and $IMAGE_URL -ne $true -and $html -ne $true){$NasaQuery}

# Save image to a file on the hard drive
if($SAVEPATH -ne ""){
