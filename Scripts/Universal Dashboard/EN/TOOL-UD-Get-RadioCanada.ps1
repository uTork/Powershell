...
<#
.SYNOPSIS
Show Radio-Canada news
.DESCRIPTION
This function was created to display news as PowerShell objects. They can be retrieved by Universal Dashboard, for example to show news on a dashboard on TVs.
.PARAMETER Information
Show information according to the selection
.PARAMETER Thematiques
Show themes according to the selection
.PARAMETER Sports
Show sports according to the selection
.PARAMETER Arts
Show arts according to the selection
.PARAMETER Regions
Show regions according to the selection
.PARAMETER Autres
Show the Other category according to the selection
.PARAMETER HTML
Show the news in an HTML summary that opens in the browser.
.LINK
Sebastien Maltais
...
# Radio-Canada HTML header image
