...
Показати новини CBC
.DESCRIPTION
Перетворити RSS-стрічку новин CBC на об’єкт або HTML
.PARAMETER GENERAL_NEWS
Показати загальні новини
.PARAMETER SPORTS_NEWS
Показати спортивні новини
.PARAMETER REGIONAL_NEWS
Показати регіональні новини
.PARAMETER HTML
...
# RSS-адреса The National
$THENATIONAL = @{
                    In_Depth_Reports = "https://rss.cbc.ca/lineup/thenational.xml"
                 }

# Вибрати загальний RSS-канал новин
if($GENERAL_NEWS -NE ""){
                         $RSS = $GENERALNEWS."$GENERAL_NEWS"                          
                        }

# Вибрати регіональний RSS-канал новин
if($REGIONAL_NEWS -ne ""){                       
                         $RSS = $REGIONALNEWS."$REGIONAL_NEWS"
                         }

# Вибрати RSS-канал The National
if($THE_NATIONAL -ne ""){
