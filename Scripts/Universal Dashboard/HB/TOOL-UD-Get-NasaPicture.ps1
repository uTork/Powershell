...
# קבלו מפתח API אישי בחינם באתר NASA https://api.nasa.gov/index.html#apply-for-an-api-key
...
# הצגת כתובת ה-HD של התמונה בלבד
if($image_url -eq $true){Write-Output $hdurl}

# יצירת דף HTML עם התמונה
if($html -eq $true){
