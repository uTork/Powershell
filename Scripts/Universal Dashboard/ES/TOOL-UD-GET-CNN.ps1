...
<#
.SYNOPSIS
Obtener noticias de CNN desde RSS
.DESCRIPTION
Convertir las noticias de CNN en objeto PowerShell para Universal Dashboard o HTML para lectura
.PARAMETER Category
Categoría de noticias
.PARAMETER HTML
Mostrar las noticias en HTML
.LINK
Sebastien Maltais
